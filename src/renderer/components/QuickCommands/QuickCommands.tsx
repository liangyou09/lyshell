 ...
 * 双击添加新命令，单击执行命令
 */
const QuickCommands: React.FC<QuickCommandsProps> = ({ onExecute }) => {
  ...
  return (
    <div
      className="flex items-center h-[24px] bg-[#252526] border-t border-[#3C3C3C] overflow-x-auto scrollbar-hide px-2"
    ...
    >
      ...
      {commands.map((cmd) => (
        <button
          ...
          className={cn(
            'px-2 py-0.5 mx-1 rounded text-xs',
