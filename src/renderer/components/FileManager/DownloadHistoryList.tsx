...
// 格式化大小：和 fileType.formatSize 风格一致，不带 'B' 后缀
      ...
      <div className="flex-1 overflow-auto rack-scroll">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full gap-2 px-4 text-center">
            ...
            <span className="text-[13px] text-[var(--text-rack-mute)]">no transfers yet</span>
            <span className="font-mono text-[12px] text-[var(--text-rack-faint)]">downloaded files will appear here</span>
          </div>
        ) : (
          <div>
            {records.map(record => {
