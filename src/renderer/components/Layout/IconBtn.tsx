...
export const IconBtn: React.FC<{
  ...
  <button
    ...
    disabled={disabled}
    className={cn(
      'win-no-drag w-[24px] h-[24px] flex items-center justify-center bg-transparent border-none rounded-[3px] cursor-pointer transition-colors disabled:opacity-50',
